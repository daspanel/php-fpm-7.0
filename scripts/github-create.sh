...
echo "Will create a new *$PRIVACYWORD* repo named php-fpm-7.0"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo PHP-FPM 7.0 server running inside Docker container using Alpine Linux with S6 Overlay init system.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"php-fpm-7.0\", \"description\": \"PHP-FPM 7.0 server running inside Docker container using Alpine Linux with S6 Overlay init system.\", \"private\": $PRIVATE_TF}"
